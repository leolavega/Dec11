...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
		...
		CGFloat widthOfBox = self.bounds.size.width/boxesPerRows -16;
		CGFloat heightOfBox = self.bounds.size.height/(totalNumberOfBoxes/boxesPerRows) -16;
